/**
 * @param {Date|number} dateIn
 * @param {number} interval - The time interval to round to. Must be between 0 and
 *   86400000, inclusive.
 */
exports.round = function round (timeIn, interval) {
  if (interval < 0) {
    throw TypeError('`interval` must be greater than or equal to 0.')
  }
